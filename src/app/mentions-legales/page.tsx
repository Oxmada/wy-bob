        ...
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <section className={`${styles.section} ${styles.section1}`}>
              <h2 className={styles.heading}>1. Édition du site</h2>
            ...
            <section className={`${styles.section} ${styles.section4}`}>
              <h2 className={styles.heading}>4. Protection des données personnelles (RGPD)</h2>
              <p className={styles.text}>
            ...
            <section className={`${styles.section} ${styles.section5}`}>
              <h2 className={styles.heading}>5. Politique de Cookies et Mesure d'Audience</h2>
              <p className={styles.text}>
            ...
            <section className={`${styles.section} ${styles.section6}`}>
              <h2 className={styles.heading}>6. Médiation de la consommation</h2>
              <p className={styles.text}>
